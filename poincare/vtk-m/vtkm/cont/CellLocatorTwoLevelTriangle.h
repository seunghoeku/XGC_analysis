...
//============================================================================
#ifndef vtk_m_cont_CellLocatorTwoLevelTriangle_h
#define vtk_m_cont_CellLocatorTwoLevelTriangle_h
...
#include <vtkm/exec/CellLocatorTwoLevelTriangle.h>
...
///
/// `CellLocatorTwoLevelTriangle` creates a cell search structure using two levels of structured
...
///
/// The algorithm used in `CellLocatorTwoLevelTriangle` is described in the following publication:
///
...
///
class VTKM_CONT_EXPORT CellLocatorTwoLevelTriangle
  : public vtkm::cont::internal::CellLocatorBase<CellLocatorTwoLevelTriangle>
{
  using Superclass = vtkm::cont::internal::CellLocatorBase<CellLocatorTwoLevelTriangle>;
...
public:
  ...
  using CellLocatorExecList =
    vtkm::ListTransform<CellExecObjectList, vtkm::exec::CellLocatorTwoLevelTriangle>;

  using ExecObjType = vtkm::ListApply<CellLocatorExecList, vtkm::exec::CellLocatorMultiplexer>;

  CellLocatorTwoLevelTriangle()
    : DensityL1(32.0f)
    , DensityL2(2.0f)
  {
  }
...
private:
  ...
  vtkm::cont::ArrayHandle<vtkm::internal::cl_uniform_bins_triangle::DimVec3> LeafDimensions;
...
#endif // vtk_m_cont_CellLocatorTwoLevelTriangle_h
