...
///
VTKM_CONT void CellLocatorTwoLevelTriangle::Build()
{
  VTKM_LOG_SCOPE(vtkm::cont::LogLevel::Perf, "CellLocatorTwoLevelTriangle::Build");
...
//----------------------------------------------------------------------------
struct CellLocatorTwoLevelTriangle::MakeExecObject
{
  template <typename CellSetType>
  VTKM_CONT void operator()(const CellSetType& cellSet,
                            vtkm::cont::DeviceAdapterId device,
                            vtkm::cont::Token& token,
                            const CellLocatorTwoLevelTriangle& self,
                            ExecObjType& execObject) const
  {
    using CellStructuredType = CellSetContToExec<CellSetType>;
    execObject = vtkm::exec::CellLocatorTwoLevelTriangle<CellStructuredType>(self.TopLevel,
                                                                     self.LeafDimensions,
                                                                     self.LeafStartIndex,
                                                                     self.CellStartIndex,
                                                                     self.CellCount,
...
CellLocatorTwoLevelTriangle::ExecObjType CellLocatorTwoLevelTriangle::PrepareForExecution(
  vtkm::cont::DeviceAdapterId device,
...
//----------------------------------------------------------------------------
void CellLocatorTwoLevelTriangle::PrintSummary(std::ostream& out) const
{
